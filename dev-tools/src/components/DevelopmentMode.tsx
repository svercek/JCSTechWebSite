  ...
  return (
    <>
      ...
      {showFloatingButton && (
        ...
        className="fixed bottom-20 left-20 w-15 h-15 rounded-full bg-intents-ux-boxLowContrast-backgroundColor backdrop-blur-10px text-white p-3 font-semibold text-sm z-999999 box-shadow-md border transition-opacity duration-200 cursor-pointer"
        style={{
      ...
      {(isSelectMode || isInlineEditing) && (
        <div
          ...
          className="fixed top-[10px] left-1/2 transform -translate-x-1/2 bg-white text-black p-3 rounded-sm font-semibold text-sm z-999998 shadow-md border border-border transition-opacity duration-200 cursor-pointer"
          style={{ opacity: isIndicatorHovered ? 0 : 1 }}
